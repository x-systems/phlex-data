...
class Statement extends AbstractStatement
{
    ...
    protected $template_select_limit = 'select * from (select "__t".*, rownum "__phlex_rownum" from ([with]select[option] [field] [from] [table][join][where][group][having][order]) "__t") where "__phlex_rownum" > [limit_start][and_limit_end]';
