...
class HintableModelTest extends \Phlex\Core\PHPUnit\TestCase
{
    ...
    protected function createDatabaseForRefTest(): \Phlex\Data\Persistence
    {
    ...
    {
        // TODO seems like a bug in phlex-data
//        $model = new Model\Standard();
//        $model->invokeInit();
