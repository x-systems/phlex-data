...
class JoinSqlTest extends Sql\TestCase
{
    public function testDirection(): void
    {
        ...
        $this->expectException(Exception::class); // TODO not implemented yet, see https://github.com/x-systems/phlex-data/issues/803
    ...
    public function testJoinSaving2()
    {
        ...
        $this->db->execute($this->db->statement()->delete()->table('contact')->where('id', 2));
