...
class SelectTest extends PHPUnit\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        foreach ([
            ...
            $this->persistence->connection->executeQuery($fixIdentifiersFunc('INSERT INTO "employee" (' . implode(', ', array_map(static fn ($v) => '"' . $v . '"', array_keys($row))) . ') VALUES(' . implode(', ', array_map(function ($v) {
                if (is_bool($v)) {
