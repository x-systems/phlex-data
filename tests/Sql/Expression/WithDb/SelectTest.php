...
class SelectTest extends PHPUnit\TestCase
{
    ...
    public function testBasicQueries()
    {
        ...
        $this->assertSame(
            '4',
            $this->q()->field(new Persistence\Sql\Expression('2+2'))->execute()->fetchOne()
        );
        ...
        $this->assertSame(
            '5',
            $this->q()->field(new Persistence\Sql\Expression('COALESCE([], \'5\')', [null]), 'null_test')->execute()->fetchOne()
        );
    }
